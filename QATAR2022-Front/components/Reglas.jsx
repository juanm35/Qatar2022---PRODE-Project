function ReglasComponent(props) {
    ...
    return (
            <div className="bg-qatarSilver w-11/12 sm:w-4/5 mx-auto rounded-md">
              ...
              <div className="pt-2 pb-2 px-8 text-black indent-6 text-md">4. Una vez conectado y con fondos, aprobá el token USDC para poder enviar tu inscripción desde la página de <strong>Mi Prode</strong>.</div>
              <div className="pt-2 pb-2 px-8 text-black indent-6 text-md">5. Una vez aprobado el token envía al smart contracto la apuesta única para participar de <strong>15 USDC</strong> a través de la página de <strong>Mi Prode</strong>.</div>    
              ...
              <ul className="list-disc list-inside pl-8">
                ...
                <li className="pt-2 pb-2 px-4 lg:px-12 text-black"> No se tomará como válido pronosticos de mas de 14 goles por equipo (Ej. no son válidos los siguientes resultados: 15-15 o 16-1 o 3-17).&#128680;</li>
                <li className="pt-2 pb-2 px-4 lg:px-12 text-black"> No se tomará como válido pronosticos que dejen uno de los dos equipos sin completar el score (Ej. no son válidos los siguientes resultados: 2- o -1 o 5-).&#128680;</li>
                <li className="pt-2 pb-2 px-4 lg:px-12 text-black"> Se puede dejar partidos enteros vacíos! Al enviar resultados, aquellos partidos no completados o no válidos no seran tomados en cuenta, dejando como válido el resultado registrado anteriormente si lo hubiese.</li>              
                ...
                <li className="pt-2 pb-2 px-4 lg:px-12 text-black"> Para la <strong>segunda fase</strong>, se considera el resultado a pronosticar el del <strong>partido completo hasta los penales</strong> (90 min o 120 min si hubiese tiempo extra). Los penales no suman ni restan puntos ni se pronostican. &#128680;</li>
              ...
              <ul className="list-decimal list-inside pl-8 pb-4">
                <li className="pt-2 pb-2 px-8 text-black">Primer Puesto: <strong>60%</strong>&#127942;.</li>
                <li className="pt-2 pb-2 px-8 text-black">Segundo Puesto: <strong>30%</strong>&#129352;.</li>
                <li className="pt-2 pb-2 px-8 text-black">Tercer Puesto: <strong>10%</strong>&#129353;.</li>
              </ul>
            </div>
    );
  }
