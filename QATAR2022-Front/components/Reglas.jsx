function ReglasComponent(props) {
    ...
    return (
            <div className="bg-qatarSilver w-11/12 sm:w-4/5 mx-auto rounded-md">
              ...
              <div className="pt-2 pb-2 px-8 text-black indent-6 text-md">2. Conectá tu wallet a la red de polygon desde la página de Mi Prode.</div>   
              ...
              <div className="pt-2 pb-2 px-8 text-black indent-6 text-md">4. Una vez conectado y con fondos, aprobá el token DAI para poder enviar tu inscripción desde la página de Mi Prode.</div>
              <div className="pt-2 pb-2 px-8 text-black indent-6 text-md">5. Una vez aprobado el token envía al smart contracto la apuesta única para participar de <strong>15 DAI</strong> a través de la página de Mi Prode.</div>    
              ...
              <div className="pt-2 px-8 text-black indent-6">En la página de Posiciones se podrá ver la tabla de posiciones con todos puntajes de los participantes registrados.</div>
